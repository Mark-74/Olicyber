...
def rol(x, n):
   ...
   """
   shifta x a sx di n, poi shifta x a dx di 128 - n e poi fa l'or, il numero diventa x + ultime N cifre (a sx) di x
   es (non con 128 bit): 
       101011111010 -> shift a sx di n = 4 -> 1010111110100000
       101011111010 -> shift a dx di n = 4 -> 0000000000001010
       risultato finale -> operazione or   -> 1010111110101010 non ho considerato la bitmask!
   """
